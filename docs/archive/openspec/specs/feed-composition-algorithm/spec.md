> **⚠️ 稽核狀態（2026-06-04，spec vs dev）：規格與實作分歧（divergent）**
...
> 待決定：(a) 改寫 spec 對齊前端現有行為，或 (b) 補後端 slot 演算法。明細見 `docs/archive/omc/openspec-audit/specs/feed-composition-algorithm.md`。
