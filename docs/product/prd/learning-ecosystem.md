...
重承諾機制還在藍圖上：Buddy 目前只有請求的發送與接受，缺配對推薦（以同 template、標題關鍵字的「相似」而非精確配對）、每日聚合打卡通知、連續五天未打卡的守望相助、里程碑慶祝，以及整個核心設計物「火苗（Ember）」——每對 Buddy 共有一簇火苗，打卡是燃料，火苗轉暗時損失的是「我們的共同進度」而非對個人的懲罰。共同挑戰已於 2026-09 上線（storage #202、server #432、f2e #953、admin-ui #115）：探索共同挑戰頁、加入自動複製實踐、參與者限定留言、六節點信件與靈感卡抽卡皆已通電；空間內的共同挑戰子頁（#174）與一般使用者自建活動（#173）仍在後續。
