...
| 2b | Spec Drafter：S 卡缺 spec 時 Actions + Workers AI 自動起草最小 OpenSpec → PR | [spec-drafter-spike.md](../archive/automation/spec-drafter-spike.md) 驗證可行 | 一張 M 卡 | [#170](https://github.com/daodaoedu/daodao/issues/170) Todo |
