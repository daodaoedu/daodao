...
先讀 [共用交接規則](../../docs/ai-human-review-workflow.md)。此流程用於已要求批次發布任務；單一需求卡使用 [gh-card](../gh-card/SKILL.md)。
...
4. 以 [子 Issue 模板](../../templates/subtask-issue.md) 保存不覆蓋的本機草稿，附標題、repo、父卡、labels、status、原任務對照及檢核摘要。遠端 body 包含足夠上下文，不能只引用本機檔案。
