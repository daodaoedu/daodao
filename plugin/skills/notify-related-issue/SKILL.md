...
先讀 [共用交接規則](../../docs/ai-human-review-workflow.md)。接受 PR URL／編號或當前分支，支援僅草稿；不得把一般開發授權當成發送留言的授權。
...
3. 起草繁體中文通知，列 PR URL、實際狀態、受驗版本、已確認結果與未驗證／未完成項。AI 先自審修訂，再展示目的 Issue 與具體 body。使用 [狀態模板](../../templates/issue-status-comment.md) 的適用欄位，不捏造報告或部署證據。
